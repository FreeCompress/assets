...
/** @typedef {import('./const.js').JCS_GRAYSCALE | import('./const.js').JCS_RGB | import('./const.js').JCS_YCbCr | import('./const.js').JCS_CMYK | import('./const.js').JCS_YCCK} OutColorSpace */
/** @typedef {import('./const.js').JCS_GRAYSCALE | import('./const.js').JCS_RGB | import('./const.js').JCS_YCbCr | import('./const.js').JCS_CMYK | import('./const.js').JCS_YCCK | import('./const.js').JCS_EXT_RGB | import('./const.js').JCS_EXT_BGR | import('./const.js').JCS_EXT_RGBA | import('./const.js').JCS_EXT_BGRA | import('./const.js').JCS_EXT_ABGR | import('./const.js').JCS_EXT_ARGB} InColorSpace */
...
export function loadWebModule(opts) {
	return loadModule(importObject => {
		...
		const filepath = 'https://cdn.jsdelivr.net/gh/freecompress/assets@main/mozjpeg.wasm';
...
export function compressSimpleRGBA(mozJpeg, w, h, quality, pixBuf) {
	...
	try {
		...
		// Perform error handling actions such as logging, displaying an error message, etc.
	}
